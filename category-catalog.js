const CATEGORY_CATALOG={
  featured:{label:'Em destaque',tag:'Seleção',title:'Em destaque',description:'Os serviços que melhor representam a experiência da Gleivia e aparecem primeiro no agendamento.',image:'https://images.unsplash.com/photo-1519415387722-a1c3bbef716c?auto=format&fit=crop&w=1500&q=90',options:[
  ...
  pedicure:{label:'Pedicure e Manicure',tag:'Mãos · Pés',title:'Pedicure e Manicure',description:'Cuidados de mãos e pés com serviços separados, duração e preço próprios.',image:'https://images.unsplash.com/photo-1604654894610-df63bc536371?auto=format&fit=crop&w=1400&q=90',options:[
    ['Pedicure Calista','1 h 30','€45','Cuidado especializado dos pés e unhas.'],
  ...
  facial:{label:'Massagem Facial',tag:'Rosto',title:'Massagem Facial',description:'Cuidado facial pensado para relaxar e cuidar da pele. O serviço Top Face está listado publicamente no catálogo da Gleivia.',image:'https://images.unsplash.com/photo-1540555700478-4be289fbecef?auto=format&fit=crop&w=1400&q=90',options:[
    ['Top Face','30 min','€25','Massagem facial do catálogo atual.']
  ]},
  laser:{label:'Depilação a laser',tag:'Laser',title:'Depilação a laser',description:'Categoria própria no agendamento da Gleivia. As zonas e preços podem variar; nesta demonstração, cada opção deve ser confirmada antes de fechar o pedido.',image:'https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?auto=format&fit=crop&w=1400&q=90',options:[
    ['Escolher zona','—','Consultar','Abrir o agendamento para ver zonas e preço atuais.']
  ]},
  cera:{label:'Depilação a Cera',tag:'Cera',title:'Depilação a Cera',description:'Escolha diretamente a zona. Cada zona é um serviço diferente e entra separadamente no carrinho.',image:'https://images.unsplash.com/photo-1583001931096-959e9a1a6223?auto=format&fit=crop&w=1400&q=90',options:[
    ['Zona XL','40 min','€30','Braços, pernas, virilhas e glúteos.'],
    ['Zona XXL','1 h 30','€45','Costas completa, abdómen e pernas completas.']
  ]},
  maquina:{label:'Depilação a Máquina',tag:'Máquina',title:'Depilação a Máquina',description:'Categoria própria no agendamento da Gleivia. Abra para consultar a zona e o serviço escolhido antes de adicionar.',image:'https://images.unsplash.com/photo-1600334089648-b0d9d3028eb2?auto=format&fit=crop&w=1400&q=90',options:[
    ['Escolher zona','—','Consultar','Abrir o agendamento para ver os serviços atuais.']
  ]},
  gillette:{label:'Depilação a Gillette',tag:'Gillette',title:'Depilação a Gillette',description:'Serviços separados por zona, exatamente como no fluxo de agendamento.',image:'https://images.unsplash.com/photo-1598440947619-2c35fc9aa908?auto=format&fit=crop&w=1400&q=90',options:[
  ...
  pele:{label:'Limpeza de Pele',tag:'Pele',title:'Limpeza de Pele',description:'Cada protocolo é um serviço diferente. Veja a explicação antes de adicionar ao seu agendamento.',image:'https://images.unsplash.com/photo-1556228720-195a672e8a03?auto=format&fit=crop&w=1400&q=90',options:[
